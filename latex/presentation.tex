...
\begin{thebibliography}{n}
	\bibitem [AB09]{AB09} S. Arora, B. Barak. \emph{Computational Complexity. A Modern 
Approach}, 2009.
	\bibitem [WP-BQP]{wp-bqp} BQP. Wikipedia, \url{http://en.wikipedia.org/wiki/BQP}.
	\bibitem [D85]{D85} D. Deutsch. \emph{Quantum theory, the Church-Turing principle and the universal quantum computer}, 1985.
	\bibitem [P94]{P94} C. Papadimitriou. \emph{Computational Complexity}, 1994.
\end{thebibliography}
\end{document}